...
import { LayoutDashboard, Users, Package, FileText, Settings, Plus, BarChart3 } from "lucide-react";
    ...
    <div className="min-h-screen flex bg-background text-foreground">
      <aside className="no-print hidden md:flex flex-col w-60 bg-sidebar text-sidebar-foreground p-4">
        <div className="mb-6">
          ...
          <div className="text-xs opacity-70">Offline · runs on your device</div>
        </div>
